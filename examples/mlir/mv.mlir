...
module {
  func @mv(%arg0: memref<?x?xi32>, %arg1: memref<?xi32>, %arg2: memref<?xi32>) {
    ...
    ^bb0(%arg3: i32, %arg4: i32, %arg5: i32):	// no predecessors
      ...
      "linalg.yield"(%3) : (i32) -> ()
    }) {args_in = 2 : i64, args_out = 1 : i64, indexing_maps = [#map0, #map1, #map2], iterator_types = ["reduction", "parallel"]} : (memref<?x?xi32>, memref<?xi32>, memref<?xi32>) -> ()
    "std.return"() : () -> ()
  }
}