...
extern "C" {
void _mlir_ciface_tmm(memref::MemRefDescriptor<CIM_PRECISION, rankA> *A,
...
int main() {
  ...
  std::array<int64_t, rankB> bDim = {N, K};
  ...
  _mlir_ciface_tmm(&A.memRefDesc, &B.memRefDesc, &C.memRefDesc);
  simulator_mark_end();
